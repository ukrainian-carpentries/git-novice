...
Знак оклику призведе до включення раніше вилученого запису.
...
Припустимо, що у вас є порожній файл `.gitignore`, і ви бачите структуру каталогів, яка виглядає так:
