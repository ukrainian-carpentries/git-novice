...
![](fig/github-create-repo-03.png){alt='Після створення нового репозиторію, GitHub показує сторінку з URL та додатковою інформацією. Вона містить інструкції для налаштування нового репозиторію GitHub як віддаленого'}
...
![](fig/github-find-repo-string.png){alt='Натискання "Copy to Clipboard" на GitHub, щоб скопіювати URL-адресу репозиторію'}
...
Тепер Альфредо має обрати пароль. Оскільки він використовує свій ноутбук на кухні, де до нього мають доступ інші люди, він хоче створити пароль. Обов'язково використовуйте пароль, який можна запам'ятати, або збережіть пароль десь у надійному місці, оскільки тут немає опції «змінити мій пароль».
